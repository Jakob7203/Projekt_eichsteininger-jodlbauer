...
public class YouTubeAudioFragment extends Fragment {
    ...
    CameraAudioFragment.OnSelectionChangedListener listener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof CameraAudioFragment.OnSelectionChangedListener) {
            listener = (CameraAudioFragment.OnSelectionChangedListener) context;
        } else {
        }
    }
